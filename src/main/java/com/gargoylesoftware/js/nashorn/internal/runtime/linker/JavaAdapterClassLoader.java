    ...
    private ClassLoader createClassLoader(final ClassLoader parentLoader, final ProtectionDomain protectionDomain) {
        return new SecureClassLoader(parentLoader) {
...

            {
                ...
                NASHORN_MODULE.addExports("com.gargoylesoftware.js.nashorn.internal.runtime", adapterModule);
                NASHORN_MODULE.addExports("com.gargoylesoftware.js.nashorn.internal.runtime.linker", adapterModule);
